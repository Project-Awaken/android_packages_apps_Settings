...
public class AwakenReleaseTypePreferenceController extends BasePreferenceController {

    private static final String TAG = "awakenReleaseTypeCtrl";
    ...
    public AwakenReleaseTypePreferenceController(Context context, String key) {
        super(context, key);
    ...
    public CharSequence getSummary() {
        return SystemProperties.get(ROM_RELEASETYPE_PROP,
